...
namespace eBookManager.Helper
{
    public static class ExtensionMethods
    {
        ...
        public static bool StorageSpaceExists(
            this List<StorageSpace> space,
            string nameValueToCheck,
            out int storageSpaceId)
        {
            bool exists = false;
            storageSpaceId = 0;
            if (space.Count != 0)
        ...
        public async static Task WriteToDataStore(
            this List<StorageSpace> value,
            string storagePath)
        {
        ...
        public async static Task<List<StorageSpace>> ReadFromDataStore(
            this List<StorageSpace> value,
            string storagePath)
        {
